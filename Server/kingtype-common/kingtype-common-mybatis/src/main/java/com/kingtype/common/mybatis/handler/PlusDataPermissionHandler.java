package com.kingtype.common.mybatis.handler;
...
import com.kingtype.common.mybatis.annotation.DataColumn;
import com.kingtype.common.mybatis.annotation.DataPermission;
import com.kingtype.common.mybatis.enums.DataScopeType;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/kingtype-Vue-Plus/issues/IB4CS4
