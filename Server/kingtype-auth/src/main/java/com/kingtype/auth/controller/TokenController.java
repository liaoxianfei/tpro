package com.kingtype.auth.controller;

import cn.dev33.satoken.exception.NotLoginException;
import cn.hutool.core.codec.Base64;
import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjectUtil;
import com.kingtype.common.core.utils.*;
...
import com.kingtype.auth.domain.vo.LoginTenantVo;
import com.kingtype.auth.domain.vo.LoginVo;
import com.kingtype.auth.domain.vo.TenantListVo;
import com.kingtype.auth.form.RegisterBody;
import com.kingtype.auth.form.SocialLoginBody;
...
import com.kingtype.common.core.domain.model.LoginBody;
import com.kingtype.common.core.utils.*;
import com.kingtype.common.encrypt.annotation.ApiEncrypt;
import com.kingtype.common.json.utils.JsonUtils;
import com.kingtype.common.ratelimiter.annotation.RateLimiter;
import com.kingtype.common.ratelimiter.enums.LimitType;
import com.kingtype.common.satoken.utils.LoginHelper;
import com.kingtype.common.social.config.properties.SocialLoginConfigProperties;
import com.kingtype.common.social.config.properties.SocialProperties;
import com.kingtype.common.social.utils.SocialUtils;
import com.kingtype.common.tenant.helper.TenantHelper;
import com.kingtype.resource.api.RemoteMessageService;
import com.kingtype.system.api.RemoteClientService;
import com.kingtype.system.api.RemoteConfigService;
import com.kingtype.system.api.RemoteSocialService;
...
public class TokenController {
    ...
    public R<LoginVo> login(@RequestBody String body) {
        ...
        scheduledExecutorService.schedule(() -> {
            remoteMessageService.publishMessage(List.of(userId), DateUtils.getTodayHour(new Date()) + "好，欢迎登录 kingtype-Cloud-Plus 后台管理系统");
        }, 5, TimeUnit.SECONDS);
        return R.ok(loginVo);
    }
